...
//LOOPING the days of the week starting from Todays date
...
//TODAY test output
let todaystring = new Int1.DateTimeFormat('en-US', options).format(today);
document.getElementById('today').innerHTML='Today is ${todaystring}.';

//next in days (CodePen example)
for (let i = 1; i <= n; i++ ) {
