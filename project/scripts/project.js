document.addEventListener("DOMContentLoaded", function() {
    ...
    function createCard(post, index) {
      ...
      const dateAndTags = document.createElement("div")
      dateAndTags.className = "date-tags"
      const pDate = document.createElement("p");
      pDate.textContent = new Date(post.date).toDateString();
      dateAndTags.appendChild(pDate);
      ...
      readMore.href = `article.html?post=${index}`;
    ...
    function displayPosts(posts) {
      ...
      // Filter and sort recent posts by date, then select the most recent 4
